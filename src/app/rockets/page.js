    ...
    <>
      <div className="bg-[#05062b] w-[100vw] h-[100vh] flex justify-center relative overflow-x-hidden sm:hidden">
        ...
        <div className="w-4/5 z-10">
          ...
          <div className="text-white w-full">
            <div>
              <h1 className="text-3xl font-julius">ROCKET</h1>
              <h6>Projects</h6>
            ...
            <div className="grid grid-cols-2 gap-8 mt-4" id="co-buttons">
              ...
              >
                <div className="row-span-4">
                  <img
                    src="../../images/rockets/water-rocket.png"
                    alt=""
                ...
                <div className="row-span-2 bg-white">
                  <div className="w-full h-full grid grid-rows-2 gap-0">
                    <div className="row-span-1">
                      <h6 className="text-[11px] font-julius">Water Rocket</h6>
                    </div>
              ...
              >
                <div className="row-span-4">
                  <img
                    src="../../images/rockets/modern-rocket.png"
                    alt=""
                    className="object-fill w-full"
                  />
                </div>
                <div className="row-span-2 bg-white">
                  <div className="w-full h-full grid grid-rows-2 gap-0">
                    <div className="row-span-1">
                      <h6 className="text-[11px] font-julius">Model Rockets</h6>
                    </div>
                    <div className="row-span-1 text-[8px]">
                      <h6 className="float-right m-1 mt-0">read more</h6>
                    </div>
          ...
          <div className="flex justify-center items-center">
            ...
            >
              ...
              <div className="w-[85%] ml-8">
                <h1 className="text-2xl font-julius">Water Rocket</h1>
                <h2>About:</h2>
                <p>
            ...
            >
              ...
              <div className="w-[85%] ml-8">
                <h1 className="text-2xl font-julius">Model Rockets</h1>
                <h2>About:</h2>
          ...
          <div className="flex justify-center items-center">
            ...
            >
              <div className="flex justify-center m-6">
                <img
                  src="../../images/rockets/trust-vector-control-system.png"
                  alt=""
                  className="w-[50%]"
                />
              </div>
              <div className="w-[85%] ml-8">
                <h1 className="text-2xl font-julius">Thrust Vector Control system</h1>
                <h2>About:</h2>
            ...
            >
              <div className="flex justify-center m-6">
                <img
                  src="../../images/rockets/piston-ejection-system.png"
                  alt=""
                  className="w-[50%]"
                />
              </div>
            ...
            >
              <div className="flex justify-center m-6">
                <img
                  src="https://raw.githubusercontent.com/sri766/udaan-website/main/images/plane-projects/udn-vtol.png"
                  alt=""
                  className="w-[50%]"
                />
              </div>
            ...
            >
              <div className="flex justify-center m-6">
                <img
                  src="https://raw.githubusercontent.com/sri766/udaan-website/main/images/plane-projects/sukhoisu-30%20UDN.png"
                  alt=""
                  className="w-[50%]"
                />
              </div>
            ...
            >
              <div className="flex justify-center m-6">
                <img
                  src="https://raw.githubusercontent.com/sri766/udaan-website/main/images/plane-projects/udn-Amphibian.png"
                  alt=""
                  className="w-[50%]"
                />
              </div>
            ...
            >
              <div className="flex justify-center m-6">
                <img
                  src="https://raw.githubusercontent.com/sri766/udaan-website/main/images/plane-projects/udn%20view.png"
                  alt=""
                  className="w-[50%]"
                />
              </div>
            ...
            <div className="grid grid-cols-2 gap-8 mt-4" id="up-buttons">
              ...
              >
                ...
                <div className="row-span-2 bg-white">
                  <div className="w-full h-full grid grid-rows-2 gap-0">
                    <div className="row-span-1">
                      <h6 className="text-[11px] font-julius">Thrust Vector Control System</h6>
                    </div>
                    <div className="row-span-1 text-[8px]">
                      <h6 className="float-right m-1 mt-0">read more</h6>
                    </div>
      ...
      <div className="w-full bg-[rgb(5,6,43)] justify-center relative overflow-x-hidden hidden sm:flex">
        ...
        <div className="w-[70%] flex z-10 text-xl  font-poppins">
          <div className="text-white">
            <div>
              <h1 className="text-5xl font-julius">ROCKET</h1>
              <h6>Projects</h6>
            ...
            <div>
              <div className="flex w-full my-5">
                <div className="w-[70%] mr-9">
                  <h1 className="text-[35px] my-4">Water Rocket</h1>
                  <h2>About:</h2>

                  <p>
                  We at UDAAN have successfully built a soda bottle water rocket that utilizes water 
              ...
              <div className="flex w-full my-5">
                ...
                <div className="w-[70%] ml-9">
                  <h1 className="text-[35px] my-4">Modern Rocket</h1>
                  <h2>About:</h2>

                  <p>
                  This project showcases a model rocket powered by a rocket candy motor. 
                  It is designed and manufactured entirely by our team. The rocket motor 
                  utilizes potassium nitrate as an oxidizer and sugar (eg. Sucrose or Sorbitol) 
                  as fuel. When ignited, the mixture undergoes a controlled combustion process, 
                  releasing a large amount of gas and generating significant thrust. Also, we designed 
                  and built every part of the structure based on aerodynamic principles. Using software 
                  tools like OpenRocket, SolidWorks, and BurnSim, we meticulously designed and analysed 
                  our model rocket. These tools allowed us to simulate the rocket's flight dynamics, motor 
                  burn profile, and overall performance.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div>
              <div className="flex w-full my-5">
                <div className="w-[70%] mr-9">
                  <h1 className="text-[35px] my-4">Thrust Vector Control system</h1>
                  <h2>About:</h2>

                  <p>
                  We are working on a TVC (Thrust Vector Controller), which is a mechanism 
                  used in model rockets to control the direction of thrust during flight. 
                  It allows the rocket to change its orientation and adjust its flight path 
                  by deflecting the engine's exhaust gases. TVC systems are typically used 
                  in advanced model rockets and high-power rockets. Creating a TVC is a complex 
                  Engg. task, and we are using knowledge from various domains like: Rocket propulsion, 
                  Aerodynamics, Control Systems, Electronics and Programming etc. for building it. 
                  We are using electronic components such as Microcontrollers (like Arduino boards, 
                  Raspberry Pi), Sensors (gyroscopes, accelerometers), Actuators, Motor controllers, 
                  Communication Interfaces (to transmit telemetry data) etc.
                  </p>
                </div>
              ...
              <div className="flex w-full my-5">
                ...
                <div className="w-[70%] ml-9">
                  <h1 className="text-[35px] my-4">Piston Ejection system</h1>
                  <h2>About:</h2>
